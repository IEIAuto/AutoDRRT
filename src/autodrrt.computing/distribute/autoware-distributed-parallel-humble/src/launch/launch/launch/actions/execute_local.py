...
class ExecuteLocal(Action):
    ...
    def execute(self, context: LaunchContext) -> Optional[List[LaunchDescriptionEntity]]:
        ...
        # self.cmd info is '/opt/ros/humble/lib/demo_nodes_cpp/talker', '--ros-args', '-r', '__node:=talk1', '-r', 'chatter:=my_chatter']
        ...
        flag, machine = remote_local_util.remote_local_select(name)
