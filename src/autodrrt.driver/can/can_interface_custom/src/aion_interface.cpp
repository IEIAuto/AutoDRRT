...
{
    RCLCPP_INFO(this->get_logger(), "[%s] the param pub_rate_ value is... %lf", "can_interface_custom", pub_rate_);
    RCLCPP_INFO(this->get_logger(), "[%s] the param report_dt_ value is... %lf", "can_interface_custom", report_dt_);
    RCLCPP_INFO(this->get_logger(), "[%s] the param command_dt_ value is... %lf", "can_interface_custom", command_dt_);
    checkCanCardStatus();
