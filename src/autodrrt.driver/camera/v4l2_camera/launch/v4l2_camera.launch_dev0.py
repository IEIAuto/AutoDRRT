...
def generate_launch_description():
    ...
    add_launch_arg('v4l2_camera_param_path','/home/orin/driver/config/camera0/v4l2_camera.param.yaml',
                   description='path to the yaml file that contains parameters for v4l2_camera node')
    add_launch_arg('camera_info_url','/home/orin/driver/config/camera0/camera_info.yaml',
