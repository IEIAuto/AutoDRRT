...
def generate_launch_description():
    ...
    add_launch_arg('image_topic','image0',
                   description='image topic name to be published')
    add_launch_arg('camera_name','camera0',
    ...
    add_launch_arg('v4l2_camera_param_path','/home/orin/disk/v4l2_camera/config/camera0/v4l2_camera.param.yaml',
                   description='path to the yaml file that contains parameters for v4l2_camera node')
    add_launch_arg('camera_info_url','/home/orin/disk/v4l2_camera/config/camera0/camera_info.yaml',
    ...
    add_launch_arg('video_device','/dev/video0',
                   description='')
