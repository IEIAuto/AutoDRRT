  ...
  const autoware_auto_perception_msgs::msg::DetectedObject & transformed_object)
{
  ...
  pcl::PointXY point_tmp((float)transformed_object.kinematics.pose_with_covariance.pose.position.x, (float)transformed_object.kinematics.pose_with_covariance.pose.position.y);
