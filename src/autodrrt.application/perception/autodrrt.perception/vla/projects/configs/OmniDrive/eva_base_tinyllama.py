...
num_epochs = 6
llm_path = 'ckpts/finetune-1.1b-llava-tiny-llama-eva640/'
...
train_pipeline = [
    ...
    dict(type='ResizeMultiview3D', img_scale=(320, 320), keep_ratio=False, multiscale_mode='value'),
    ...
    dict(type='Collect3D', keys=['lane_pts', 'input_ids', 'vlm_labels', 'traj_tensor','gt_bboxes_3d', 'gt_labels_3d', 'img', 'gt_bboxes', 'gt_labels', 'centers2d', 'depths', 'prev_exists'] + collect_keys,
...
load_from="./ckpts/eva_base_remapped.pth"
resume_from=None
