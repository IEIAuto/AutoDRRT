...
/*
        if (box.score >= 0.9) {	
            eigen_boxes.emplace_back(Box2Eigen(box));
        } else if (box.score < 0.9 && box.score > 0.2) {
            if (box.label < 1 || box.label >= 0) {
                eigen_boxes.emplace_back(Box2Eigen(box));
            }
        }
*/
/*
        if (box.label > 3 && box.label < 7 && box.score > 0.5) {
        //if (box.score > 0.2 && box.label == 4 || box.label == 5 || box.label == 6) {
            eigen_boxes.emplace_back(Box2Eigen(box));
        } else if (box.label < 4 || box.labe > 6 &&  box.score > 0.2) {
            eigen_boxes.emplace_back(Box2Eigen(box));
        }
*/
    }
...
/*
        if (i == 0) {
            cv::imwrite("/home/orin/disk/ros2_bevdet/bevdet_tools/CAM_FRONT_RIGHT.png", test_img);
        } else if (i == 1) {
            cv::imwrite("/home/orin/disk/ros2_bevdet/bevdet_tools/CAM_FRONT_LEFT.png", test_img);
        } else if (i == 2) {
            cv::imwrite("/home/orin/disk/ros2_bevdet/bevdet_tools/CAM_BACK_RIGHT.png", test_img);
        } else if (i == 3) {
            cv::imwrite("/home/orin/disk/ros2_bevdet/bevdet_tools/CAM_FRONT.png", test_img);
        } else if (i == 4) {
            cv::imwrite("/home/orin/disk/ros2_bevdet/bevdet_tools/CAM_BACK_LEFT.png", test_img);
        } else if (i == 5) {
            cv::imwrite("/home/orin/disk/ros2_bevdet/bevdet_tools/CAM_BACK.png", test_img);
        }
*/
...
*/
    ...
    //Boxes2Txt(ego_boxes, "/home/orin/disk/ros2_bevdet/sample0/sample0_lidarbox.txt", false);
    ...
    cv::Mat small_one;    
    cv::resize(Picx6, small_one, cv::Size(), 0.5, 0.5, cv::INTER_AREA);
