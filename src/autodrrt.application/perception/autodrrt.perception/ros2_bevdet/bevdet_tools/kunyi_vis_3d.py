...
def inference_result(json_path):
    ...
    # pkl_data = read_pkl("/home/liry/swpld/AD1129/label/kunyi_infos_val.pkl")
    ...
    for cam_type in ['CAM_FRONT_RIGHT', 'CAM_FRONT_LEFT', 'CAM_BACK_RIGHT', 'CAM_FRONT', 'CAM_BACK_LEFT', 'CAM_BACK']:
        ...
        box_path = "/home/orin/disk/autodrrt_v2.0/src/autodrrt.application/perception/autodrrt.perception/ros2_bevdet/sample0/sample0_lidarbox.txt"
        bbox = result = np.loadtxt(box_path).reshape(-1, 9)
        ...
        img_path = "/home/orin/disk/autodrrt_v2.0/src/autodrrt.application/perception/autodrrt.perception/ros2_bevdet/bevdet_tools/" + cam_type + ".png"
        print(img_path)
        ...
        final_path = '/home/orin/disk/autodrrt_v2.0/src/autodrrt.application/perception/autodrrt.perception/ros2_bevdet/bevdet_tools/result/'
        #final_path = '/home/orin/swpld/hermes_back/Lidar_AI_Solution/ros2_bevfusion/src/ROS2-CUDA-BEVFusion/bevdet_tools/result/' +  "/"
        try:
        ...
        cv2.imwrite(final_path + value, camera_image)
