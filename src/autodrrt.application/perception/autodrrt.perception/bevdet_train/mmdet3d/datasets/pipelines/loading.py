...
class PointToMultiViewDepth(object):
    ...
    def __call__(self, results):
        ...
        for cid in range(len(results['cam_names'])):
            ...
            # print("-------------------")
            # print(results['curr']['cams'][cam_name]
            #     ['ego2global_rotation'])
            # print(Quaternion(
            #     results['curr']['cams'][cam_name]
            #     ['ego2global_rotation']).rotation_matrix)
            ...
            # print(results['curr']['lidar2ego_translation'])
            # print(results['curr']['lidar2ego_rotation'])
            # print(results['curr']['ego2global_rotation'])
            # print(results['curr']['ego2global_translation'])
            # print(results['curr']['cams'][cam_name]['sensor2ego_rotation'])
            # print(results['curr']['cams'][cam_name]['sensor2ego_translation'])
            # print(results['curr']['cams'][cam_name]['ego2global_rotation'])
            # print(results['curr']['cams'][cam_name]['ego2global_translation'])
