...
class KunyiDataset(Custom3DDataset):
    r"""NuScenes Dataset.
    ...
    #            'barrier')
    #CLASSES = ("pedestrian","car","bicycle","other","truck","bus","construction_vehicle","motorcycle")
    CLASSES = ("car","bicycle","other","truck","bus","construction_vehicle","motorcycle")
