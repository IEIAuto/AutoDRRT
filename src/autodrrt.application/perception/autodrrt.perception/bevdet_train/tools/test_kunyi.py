...
def main():
    ...
    print("=======test_dataloader_default_args===============")
    print(test_dataloader_default_args)
    ...
    # images, sensor2egos, ego2globals, intrins, post_rots, post_trans, bdas = img_inputs
    # print(images.shape)
    # print(sensor2egos.shape)
    # print(ego2globals.shape)
    # print(intrins.shape)
    ...
    if rank == 0:
        ...
        import json 
        with open("kunyi_test_output.json", mode="w", encoding='utf-8') as f:
            json.dump(result, f) 
        print("===================end=======================")
