...
static const _Dmamessage_type_support_symbol_names_t _Dmamessage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dma_customer_msg, msg, Dmamessage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dma_customer_msg, msg, Dmamessage)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dma_customer_msg, msg, Dmamessage)() {
  return &::dma_customer_msg::msg::rosidl_typesupport_c::Dmamessage_message_type_support_handle;
}
