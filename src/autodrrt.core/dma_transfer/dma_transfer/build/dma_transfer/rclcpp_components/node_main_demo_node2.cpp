...
#define NODE_MAIN_LOGGER_NAME "demo_node2"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libdma_transfer.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<dma_transfer::DemoNode2>";
