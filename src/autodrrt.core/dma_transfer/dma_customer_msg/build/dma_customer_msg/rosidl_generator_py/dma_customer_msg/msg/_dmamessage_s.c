...
bool dma_customer_msg__msg__dmamessage__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dma_customer_msg.msg._dmamessage.Dmamessage", full_classname_dest, 43) == 0);
  }
  dma_customer_msg__msg__Dmamessage * ros_message = _ros_message;
  {  // data
...
{
  /* NOTE(esteve): Call constructor of Dmamessage */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dma_customer_msg.msg._dmamessage");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Dmamessage");
